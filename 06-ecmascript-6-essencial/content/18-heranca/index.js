...
class Poligono 
{
    ...
    {
        let caracteristicas = `Eu sou um ${this.nome}, tenho ${this.lados}, tenho como largura ${this.largura} cm, e tenho como altura ${this.altura} cm`;
        console.log (caracteristicas);
        document.getElementById ("output").innerHTML += `<p> ${caracteristicas} </p>`;
    }
}
